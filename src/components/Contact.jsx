  ...
  return (
    <section id="contact" className="mt-40" >
        <div className="mx-auto max-w-6xl" >
            ...
            <p className="my-4 text-center text-2xl font-medium text-lime-300 lg:pb-6 lg:text-5xl" >{CONTACT.email}</p>
        ...
        <p className="my-8 text-center text-gray-400" >Thanks to see my portfolio</p>
    </section>
  )
}
